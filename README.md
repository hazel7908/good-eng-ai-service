...
│   ├── {사업 8}/                     소음진동 7건 + 대기질 4건 (겹침 있음)
│   └── _variants.md                  사업 간 변이표 + 정답지 자기모순 13건
│
...
| 3 | **나머지 파트 확대** — 다음: **지역개황(0200, 08-13 미팅 확정)**, 이후 수질 등 | 🔄 다음 단계 (10월 말 전체 구현 목표) |
| 4 | NAS 정본 카탈로그 v2 + 전체 카테고리 지도 | ⬜ 8월 말 (NAS 업로드 완료 후) |
| 5 | 실전 시범 (정답 없는 신규 사업 — 환26 계열 후보) | ⬜ 10월 실무자 미팅 이후 |
