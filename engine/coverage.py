...
STATUS = {
    ...
    "본환 env-impact": (10, {   # 30파트 실측(⑭) — rule 스텁 0.25 · 베이스+되먹임 13파트 0.7 (09-04 Windows ⑱)
        "summary": 0.7, "project-overview": 0.7, "target-area": 0.7, "regional-overview": 0.25, "scoping": 0.7, "public-opinion": 0.7, "alternatives": 0.7, "conservation-goal": 0.7, "flora-fauna": 0.25, "natural-assets": 0.7, "climate": 0.7, "air-quality": 0.25, "greenhouse-gas": 0.25, "water-quality": 0.25, "land-use": 0.25, "soil": 0.7, "topo-geology": 0.25, "resource-cycle": 0.25, "noise-vib": 0.25, "landscape": 0.25, "population-housing": 0.7, "strategic-reflection": 0.7, "mitigation-postmonitoring": 0.7, "unavoidable-impact": 0.7, "resident-damage": 0.7, "conclusion": 0.7, "appendix-1": 0.7, "appendix-2": 0.7, "appendix-3": 0.7, "water-total-load": 0.25
    }),
