...
STATUS = {
    "소환 small-env": (76, {
        ...
        "0600 입지타당성": 0.1, "0711 동식물상": 0.1, "0725 지형지질": 0.1,
        "0728 경관": 0.1, "0800 부록": 0.1, "0840 총량검토서": 0.1,
    }),
    "소재평 small-disaster": (55, {
        "1장 개요": 0.5, "2장 대상지역": 0.5, "7장 결론": 0.5,     # spec+핸들러, ⑩ 대기
        "3장 기초현황": 0.3, "4장 예측평가": 0.3, "5장 저감대책": 0.3,
        "6장 유지관리": 0.3, "8장 부록": 0.1,
    }),
    "재평 disaster-impact": (16, {
        f"{i}장": 0.25 for i in range(1, 9)     # 골든 + 소재평 rule 준용 (자기 spec 없음)
    }),
    "검토서 disaster-review": (4, {
        "1장 개요": 0.3, "2장 대상지역": 0.3, "3장 기초현황": 0.3,
        "4장 위험요인": 0.3, "5장 부록": 0.1,
    }),
