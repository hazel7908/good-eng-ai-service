...
STATUS = {
    ...
    "소재평 small-disaster": (55, {
        ...
        "3장 기초현황": 0.7, "4장 예측평가": 0.7, "5장 저감대책": 0.7,   # 베이스+되먹임 ✅ 09-03 (⑯ — 소재평 8장 전부)
        #   3장 09-08 참고 채점 36.2% · WRONG 1건은 골든 추출 깨짐(?? 특수문자 — rule ⑥-1 기록)
        #   = 코드로 고칠 0. 단 구 vars(골든 발췌 잔존) 산출물이라 순환 포함 — 정리판 재생성 후 승급
