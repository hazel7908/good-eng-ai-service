...
BLANK = [("오수발생량", 2, 8), ("발생부하량", 2, 8), ("배출부하량", 2, 6), ("원단위", 2, 6), ("연면적(㎡)", 1, 1), ("토지이용면적", 2, 4),
         # ⚠️ 09-08 anchor_propose + 손 판정 — 미처리 19표 중 **사업 고유 4개만**.
         #    🚨 나머지 15표는 전부 고정이다: 환경영향평가 대상사업 종류·범위·협의
         #    요청시기(법령) · 재협의 실시근거(법령) · 수질오염총량검토 실시근거(법령) ·
         #    생활계 오수발생 표준농도 · 토지이용별 발생원단위 · 비점오염저감시설
         #    저감효율 · 강우처리비 적용계수 2종 · 생태면적률 가중치.
         ("일련번호", 1, 2), ("증·감", 2, 2), ("용도구획", 2, 2)]
