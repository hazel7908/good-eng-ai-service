...
BLANK = [("토양오염우려기준", 2, 1), ("비옥토 미분포지역(㎡)", 1, 1), ("농약사용면적", 2, 2), ("비료살포", 2, 1),
         # ⚠️ 09-08 3차 — 조사내용·측정지점만 사업 고유. 비옥토 채취계획·사후조사는 표준 문안.
         ("조    사    내    용", 1, 1), ("측정위치", 1, 1)]
...
EXPECT = ['골프장명_약칭', '시군', '폐유_서술', '농약영향_서술2', '비옥토_서술', '농약영향_서술3', '비료_서술', '유출영향_서술', '사후조사_도입', '부지정지_서술', '근로자_서술', '농약영향_서술1', '농약사용량_서술', '농약원단위_서술', '측정결과_서술', '측정지점_서술', '유발시설_서술', '영향예측_도입', '지점변경_주', '조사시기_2차', '측정일_2차', 'S2_위치', 'S3_위치_1차', 'S3_위치_2차', '조사시기_1차', 'S1_위치', '측정일_1차', '사업명']
