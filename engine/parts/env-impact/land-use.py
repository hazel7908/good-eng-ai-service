...
BLANK = [("구,대,도,목,천", 2, 4), ("개발행위대상", 1, 1), ("기획재정부", 2, 2),  # ⚠️ 09-08 anchor_check — 옛 앵커는 표 밖(캡션)이거나 문단 경계로 쪼개져 영원히 못 찾았다
         ...
         # ⚠️ 09-08 anchor_propose — 추가부지 조서 2표 + 토지이용계획.
         #    🚨 나머지 ⚠️ 는 **상위계획 인용표**(국가환경종합계획 7대 전략 ·
         #    6대 추진전략 · 강원도 발전방향 · 발전축 · 생활권 설정 기준 ·
         #    생태면적률 적용기준)라 고정이다. 단 `강원도` 는 사업이 바뀌면 도가
         #    달라지므로 **절 세트 자체가 가변**인 부류다 — 할 일 2·8·10 과 함께.
         ("필 지 수", 1, 5), ("용도구획", 2, 1)]
