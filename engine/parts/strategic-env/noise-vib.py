...
BLANK = [("주 간(dB(A))", 2, 1), ("주 간(dB(V))", 2, 1), ("소음도", 2, 3), ("진동레벨", 2, 2), ("정온시설", 2, 3)]
# ⚠️ 09-08 — 미처리 5표를 훑었으나 **더 달 것이 없다.** 소음환경기준·생활소음 규제기준·
#    생활진동 규제기준은 **법령표**라 고정이고, 나머지는 장 표지·간지 오검출이다.
#    측정지점 표는 `정온시설` 앵커가 이미 닿는다.
