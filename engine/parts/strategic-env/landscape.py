...
BLANK = [("문화재", 2, 2), ("조망점", 2, 6), ("생태자연도", 1, 3),
         ("수종", 1, 1), ("백두대간보호지역", 2, 1),
         # ⚠️ 09-08 anchor_suggest — 되먹임 사각 5표. `조망점` 경관현황 표가
         #    `(계속)` 으로 이어져 limit 3 을 넘겼다 → 6 으로. 지정현황 2표는 지역값.
         ("시·군·구별 면적(㎢)", 2, 1), ("명칭(소재지)", 1, 1)]
...
EXPECT = ['계획구간위치_서술', '서술_161', '서술_258', '서술_306', '서술_200', '서술_587', '서술_243', '서술_591', '서술_594', '서술_571', '서술_96', '서술_564', '서술_241', '서술_561', '서술_159', '서술_568', '서술_575', '서술_584', '서술_578', '계획명', '시군', '읍면', '하천1_명', '하천2_명']
